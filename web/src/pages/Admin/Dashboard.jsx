          ...
          <ul className="space-y-2 tracking-wide mt-8">
            ...
            <li>
              <a href="/addSpotes" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                ...
                <span className="group-hover:text-gray-700">Ajouter Spots</span>
              </a>
            </li>
              ...
              <table class="min-w-full table-auto">
                <thead>
                  <tr class="bg-gray-200 uppercase text-xs font-bold text-gray-600">
                    ...
                    <th class="py-3 px-4 border-b border-gray-300">Latitude</th>
                    <th class="py-3 px-4 border-b border-gray-300">Longitude</th>
                    <th class="py-3 px-4 border-b border-gray-300">Modifier</th>
                ...
                <tbody>
                  {filteredSpots.map((spot, index) => (
                    <tr key={index} class="hover:bg-gray-100">
                      ...
                      <td class="py-3 px-4 border-b border-gray-300">{spot.ville}</td>
